...
var helmapplicationsResource = v1alpha1.SchemeGroupVersion.WithResource("helmapplications")

var helmapplicationsKind = v1alpha1.SchemeGroupVersion.WithKind("HelmApplication")
